...
from issue2test.test_generation.test_gen import construct_topn_file_context
from issue2test.util.compress_file import get_skeleton
from issue2test.util.postprocess_data import extract_code_blocks, extract_locs_for_files
from issue2test.util.preprocess_data import show_project_structure, get_full_file_paths_and_classes_and_functions, \
    line_wrap_content, get_repo_files


class LLMLocateSourceFiles(Locate):
...
"""
    ...
    """
    To identify the files in the repository that are most relevant to the issue
    """
    def localize(self, top_n=1, mock=False) -> tuple[list, list, list, any]:
        ...
        from issue2test.util.llm_invocations import (
        ...
        config = create_chatgpt_config(
            ...
            temperature=0,
            batch_size=1,
            model="gpt-4o-2024-08-06",  # use gpt-4o for now.
        )
    ...
    """
    To identify relevant functions or classes within the files identified in the previous step
    """
    ...
    """
    To identify relevant functions or classes within a compressed representation of the files. 
    This helps save on the number of tokens used.
    """
    ...
    """
    To pinpoint the exact lines within functions or classes that need to be edited
    """
